...
export async function GET(req: NextRequest) {
  try {
    ...
    // Get preferred currency from query or default to USD
    const url = new URL(req.url)
    const preferredCurrency = url.searchParams.get('currency') || 'USD'
    ...
    await Promise.all(wishlists.flatMap(wishlist =>
